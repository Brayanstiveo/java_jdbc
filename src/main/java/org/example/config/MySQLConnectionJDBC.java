...
public class MySQLConnectionJDBC {
    ...
    static final String URL = "jdbc:mysql://localhost:3306/java_jdbc";
    ...
    private static void insertSQL(Connection conexion, Persona persona){
        ...
        try {
            ...
            String insertarSQL = "INSERT INTO `personas`(`nombre`, `apellido`, `numero_documento`, `email`, `telefono`) VALUES (?,?,?,?,?)";
    ...
    private static void actualizarSQL (Connection conexion, Persona persona){
        ...
        try {
            ...
            String consultaSQL = "UPDATE personas SET nombre = ?, apellido = ?, numero_documento = ?, email = ?, telefono = ?  WHERE id_persona = ?";
    ...
    private static void eliminarSQL(Connection conexion,Persona persona){
        ...
        try {
            ...
            String consultaSQL = "DELETE FROM `personas` WHERE id_persona = ?";
            preparedStatement = conexion.prepareStatement(consultaSQL);
